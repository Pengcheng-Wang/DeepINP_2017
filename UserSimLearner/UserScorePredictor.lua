    ...
    if opt.ciunet == '' then
        ...
        elseif opt.uppModel == 'lstm' then
            ...
            if opt.uSimGru == 0 then
                ...
                lstm.i2g.modules[2].modules[3]:init({'bias', {{2*opt.lstmHd+1, 3*opt.lstmHd}}}, nninit.constant, 1)   -- Fixed a bug here. Here we want initially set forget gate biases to 1.
