...
opt = lapp[[
       ...
       --scorePredStateScope     (default 20)        The range of distance of a player state to the end of the player interaction trajectory (ending state) that makes the state a valid training data poing for score prediction
    ]]
